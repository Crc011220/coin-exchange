...
import com.rc.geetest.GeetestLibResult;
import com.rc.util.IpUtil;
import lombok.Data;
...
public class GeetestForm {
    ...
    public void check(GeetestForm geetestForm, GeetestLib geetestLib, RedisTemplate<String,Object> redisTemplate){
        ...
        String statusStr = redisTemplate.opsForValue().get(GeetestLib.GEETEST_SERVER_STATUS_SESSION_KEY+ ":" + geetestForm.getUuid()).toString();
