...
import com.rc.model.LoginResult;
import com.rc.service.SysLoginService;
...
public class SysLoginServiceImpl implements SysLoginService {
    ...
    public LoginResult login(String username, String password) {
        ...
        String jwtJsonStr = jwt.getClaims(); //jwt的json字符串
        ...
        redisTemplate.opsForValue().set(token, "", jwtToken.getExpiresIn(), TimeUnit.SECONDS); // 缓存token
        return new LoginResult(jwtToken.getTokenType() + " " + token, menus, authorities); //加上bearer 前缀
